...
busi_feat <- extract.features(busi_bigr_lib,"business")
sport_feat <- extract.features(sport_bigr_lib,"sport")
entertain_feat <- extract.features(entertain_bigr_lib,"entertainment")
politics_feat <- extract.features(politics_bigr_lib,"politics")
tech_feat <- extract.features(tech_bigr_lib,"technology")
